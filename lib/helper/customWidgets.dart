                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: Slider(
                            value: prefs.limiteToken,
                            min: prefs.limiteToken,
                            max: 300,
                            divisions: 100,
                            label: prefs.limiteToken.round().toString(),
                            onChanged: (data) {
                              setState(() {
                                prefs.limiteToken = data;
                              });
                            },
                          ),
                        ),
                        ...
                        MaterialButton(
                            ...
                            onPressed: () {
                              if (state.tokens < prefs.limiteToken) {
                                Fluttertoast.showToast(msg: 'Te Faltan Tokens');
                              } else {
                                Fluttertoast.showToast(
                                    msg: 'Alterado Correctamente');
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Padding(
                    padding: EdgeInsets.all(8.0),
                    child: Text(
                      "Como primera instalación del sistema tienes disponible 2.000 tókenes gratuitos para que puedas hacer sus primeras preguntas o genera sus primeras imágenes, Disfrútelo",
                      style: TextStyle(color: Colors.white, fontSize: 13),
                    ),
                  ),
                  const SizedBox(
